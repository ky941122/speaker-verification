...
# @Date   : 2019-07-25
# @Author : KangYu
# @File   : experiment_sent_length_weight.py
...
def train_attention(config):
    ...
    #### sent length weight ####
    sent_len_weight = tf.expand_dims(sent_len, -1)
    sent_len_weight = sent_len_weight / tf.constant(10)
    sent_len_weight = tf.cast(sent_len_weight, tf.float32)
    voice_A_top = voice_A_top * sent_len_weight
    ############################
...
if __name__ == "__main__":
    ...
    config.model_name = "sent_length_weight_local"
